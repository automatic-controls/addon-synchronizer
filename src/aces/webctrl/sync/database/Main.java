...
public class Main {
  ...
  /** Task processing queue which permits the main thread to take some work (e.g. message logging) away from the server thread pool. */
  ...
  public static void main(String[] args){
    ...
    try{
      ...
      syncFolder = rootFolder.resolve("addons").normalize();
      try{
  ...
  public static boolean restart(){
    try{
      Runtime.getRuntime().exec(new String[]{"cmd","/c","start","",WINSW,"restart",serviceXML});
      return true;
    }catch(Throwable e){
